...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        # ground
        self.ground_surf = pygame.image.load('assets/result1.png').convert_alpha()
...
class borders:
    leftborder = (4, 0, 5, 1080)
    shopentrance = (727 , 517, 57, 1)
    shop = (631, 547,245, -210 )
class gui:
...
while True:
    ...
    pygame.draw.rect(screen, (0,255,0), borders.leftborder, 4)
   

    
    if keys[pygame.K_F10]:
        hitboxdraw = True
    elif player.rect.colliderect(borders.leftborder):
        pygame.draw.rect(screen, (255,0,0), player.rect, 4)
        player.rect.x += 5
    elif player.rect.colliderect(borders.shopentrance):
        pygame.draw.rect(screen, (255,0,0), player.rect, 4)
    elif player.rect.colliderect(borders.shop):
        pygame.draw.rect(screen, (255,0,0), player.rect, 4)
        player.rect.x += 5
        player.rect.y  += 5
